...
## ⚙️ How It Works
1. The user enters a job description into the web interface.  
2. The text is transformed using TF-IDF vectorization.  
3. A trained Logistic Regression model analyzes patterns in the text.  
4. The system predicts whether the job post is:
   - ⚠ Scam  
   - ✅ Legitimate  
